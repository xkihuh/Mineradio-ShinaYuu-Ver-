...
This document describes the official Windows release pipeline for the ShinaYuu Music 1.1.7 patch release build.
...
dist\ShinaYuu-Music-1.1.7-Setup.exe.sha256.txt
```
...
```powershell
Get-Item .\dist\ShinaYuu-Music-1.1.7-Setup.exe |
