...
This document describes the official Windows release pipeline for the ShinaYuu Music 1.1.5.4 patch release build.
...
dist\ShinaYuu-Music-1.1.5.4-Setup.exe.sha256.txt
```
...
```powershell
Get-Item .\dist\ShinaYuu-Music-1.1.5.4-Setup.exe |
