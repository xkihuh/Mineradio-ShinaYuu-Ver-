...
This document describes the official Windows release pipeline for the ShinaYuu Music 1.1.6.7 patch release build.
...
```text
dist\ShinaYuu-Music-1.1.6.7-Setup.exe
dist\ShinaYuu-Music-1.1.6.7-Setup.exe.sha256.txt
```
...
```powershell
Get-Item .\dist\ShinaYuu-Music-1.1.6.7-Setup.exe |
